// engler, cs140e: bit manipulation routines.  makes them a bit 
// clearer.  these all work on 32-bit unsigned and return 
// the result (no side-effects).
//
// TODO: 
//   - make 64 bit versions?  use macro hacks?
