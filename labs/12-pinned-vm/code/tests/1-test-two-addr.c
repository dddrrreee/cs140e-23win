...
void notmain(void) { 
    ...
    pin_t user1 = pin_mk_user_16mb(dom_kern, ASID1, no_user, MEM_uncached);
    pin_t user2 = pin_mk_user_16mb(dom_kern, ASID2, no_user, MEM_uncached);
    ...
    staff_set_procid_ttbr0(0, ASID2, null_pt);
